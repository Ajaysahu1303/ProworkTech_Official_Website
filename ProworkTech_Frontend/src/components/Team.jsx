                ...
                <div className="relative overflow-hidden rounded-3xl aspect-[4/5] mb-8 shadow-xl bg-slate-100">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary-900/90 via-primary-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-8">
                    <div className="flex gap-3">
                      <a href={member.social?.linkedin || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white hover:bg-primary-600 transition-colors">
                        <Linkedin size={20} />
                      </a>
                      <a href={member.social?.twitter || "#"} target="_blank" rel="noreferrer" className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-xl flex items-center justify-center text-white hover:bg-primary-600 transition-colors">
                        <Twitter size={20} />
                      </a>
